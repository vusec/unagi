...
import com.majdan.sensordynamics.KeyListener;
...
public class LatinIME extends InputMethodService
    ...
    private static final String PREF_SCRAMBLE_OUTPUT = "scramble_output";
    ...
    private static final String TagKeyStroke = "DynLog";
    ...
    private boolean mScrambleOutput;
    ...
    // dyn log variables
    private static final boolean EMULATOR_MODE = false; // when true sensorsimulator is used, else real sensors
    private int down_counter = 1;
    private int previousKeyDownCode = 0;
    //private static ArrayList<KeyStrokeDiagram> keyStrokeList = new ArrayList<KeyStrokeDiagram>();
    private static ArrayList<String> keyStrokeData = new ArrayList<String>();
    static String keylogFileName = "keystrokedynamics"; // prefix
    //private SensorManager _sensorManager;
    //private SensorManagerSimulator _sensorManagerSimulator;
    private SensorManager _sensorManager;
    ...
    private int _latestBatteryStatus = 0;
    private double _lat = 0;
    private double _long = 0;
    private float accel_x, accel_y, accel_z = 0;
    private float mag_x, mag_y, mag_z = 0;
    private float ori_x, ori_y, ori_z = 0;
    
    public static final boolean SIMULATION_TRHEAD_ON = false;
    
    private KeyStrokeDiagram currentDiagram = null;
    
    /**
     * Broadcast receiver used for reading the battery status
     */
    private BroadcastReceiver _batteryReceiver = new BroadcastReceiver()
    {
    	...
    	public void onReceive(Context arg0, Intent arg1)
    	{
    		...
    		{
    			_latestBatteryStatus = arg1.getIntExtra("level", 0);
    			Log.d(TagKeyStroke, "onReceive: battery percentage: " + String.valueOf(_latestBatteryStatus) + "%");
    		}
    	}
    };
    
    /**
     * Location listener, used for reading GPS location
     * 
     * @author marthijn
     *
     */
    private class MyLocationListener implements LocationListener
    {
		...
		public void onLocationChanged(Location arg0) {
			...
			Log.d(TagKeyStroke, "onLocationChanged: lat: " + _lat + " long: " + _long);
    ...
    private float[] _last_accel = null;
    private float[] _last_mag = null;
    ...
    private class KeyStrokeDiagram
    {
    	...
    	public float accel_x, accel_y, accel_z, accel_x_up, accel_y_up, accel_z_up;
        public float mag_x, mag_y, mag_z, mag_x_up, mag_y_up, mag_z_up;
        public float ori_x, ori_y, ori_z, ori_x_up, ori_y_up, ori_z_up;
    }
	...
	@Override public void onCreate() {
		...
		// start automation communicator
        // TODO Majdan
		Log.v("MAJDAN", "LatinIME.onCreate");
    ...
    @Override public void onDestroy() {
        ...
        // TODO Majdan
		Log.v("MAJDAN", "LatinIME.onDestroy");
    ...
    public View onCreateInputView() {
    	Log.d(TagKeyStroke, "onCreateInputView()");
        ...
        //mInputView.setOnKeyboardActionListener(new MyOnKeyboardActionListener());
        
        /*AlertDialog.Builder b = new AlertDialog.Builder(mInputView.);
        b.setTitle("test");
    ...
    public void onStartInputView(EditorInfo attribute, boolean restarting) {
    	Log.d(TagKeyStroke, "onStartInputView()");
        ...
        boolean disableAutoCorrect = true; // false
        mPredictionOn = false;
        mCompletionOn = false;
        mCompletions = null;
        mCapsLock = false;
        ...
        if (TRACE) Debug.startMethodTracing("/data/trace/latinimedl");
        
        
        /*AlertDialog b = new AlertDialog.Builder(this.getApplicationContext()).create();
        b.setTitle("test");
        b.setMessage("asdfasdfasdfasdf");
        b.setButton("Yes", new DialogInterface.OnClickListener() {
    ...
    public void onFinishInput() {
    	Log.d(TagKeyStroke, "onFinishInput()");
        super.onFinishInput();
    ...
    public String getActiveProgramName()
    {
    	...
    	Log.d(TagKeyStroke, "Foreground App: " + result);
    	return result;
    }
    ...
    public void updateShiftKeyState(EditorInfo attr) {
        ...
        if (attr != null && mInputView != null && mKeyboardSwitcher.isAlphabetMode()
            ...
            if (mAutoCap && ei != null && ei.inputType != InputType.TYPE_NULL) {
    ...
    private static LinkedList<KeyListener> keyListeners = new LinkedList<KeyListener>(); 
    public static void registerKeyListener(KeyListener kl) {
    	keyListeners.add(kl);
    }
	...
	public void onPress(int primaryCode) {
		...
		// TODO Majdan
		Log.v("MAJDAN", "LatinIME.onPress");
		for(KeyListener kl : keyListeners) {
    		kl.onMyKeyDown(primaryCode);
    	}
	...
	public void onRelease(int primaryCode) {
        //vibrate();
		// TODO Majdan
		Log.v("MAJDAN", "LatinIME.onRelease");
		for(KeyListener kl : keyListeners) {
    		kl.onMyKeyUp(primaryCode);
    	}
    }
    ...
    private void loadSettings() {
        ...
        mScrambleOutput = sp.getBoolean(PREF_SCRAMBLE_OUTPUT, false);
    ...
    private void showOptionsMenu() {
        ...
        CharSequence itemInputMethod = getString(17040046);
