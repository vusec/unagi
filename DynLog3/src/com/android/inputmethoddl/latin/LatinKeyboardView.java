...
public class LatinKeyboardView extends KeyboardView {
    ...
    //private MyOnKeyboardActionListener mal = new MyOnKeyboardActionListener();

    public LatinKeyboardView(Context context, AttributeSet attrs) {
        super(context, attrs);
        Log.d("DynLogView", "LatinKeyboardView");
        //this.setOnKeyboardActionListener(mal);
